...
const badges = [
  ...
  { icon: Shield, label: "100% Insured", sub: "Protected" },
  { icon: Clock, label: "24/7 Service", sub: "Always On" },
];
      ...
      <div className="relative max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-primary-500/20 text-primary-500 text-xs sm:text-sm mb-5">
              <span className="w-2 h-2 bg-primary-500 rounded-full" />
              India's #1 Premium Valet Service
            </div>

            {/* HEADING */}
            <h1 className="font-black text-3xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight mb-5">
              Your <span className="gradient-text">Driver</span>
              <br />
              One Tap <span className="gradient-text">Away</span>
            </h1>
            ...
            {/* TEXT */}
            <p className="text-gray-400 text-sm sm:text-base md:text-lg max-w-md mx-auto lg:mx-0 mb-6">
              Your car, your schedule — our drivers.
              <br />
              Premium valet services starting at ₹149/hr.
              <br />
              Available 24/7.
            </p>
            ...
            {/* MOBILE BADGES (NEW) */}
            <div className="flex lg:hidden justify-center gap-3 flex-wrap mb-6">
              {badges.map((b) => (
                <div key={b.label} className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5">
                  <b.icon size={14} className="text-primary-500" />
                  <div className="text-left">
                    <p className="text-xs text-white">{b.label}</p>
          ...
          <div className="flex justify-center lg:justify-end">
            ...
            <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md">
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <div className="flex gap-2 items-center">
                    <div className="w-7 h-7 rounded-full bg-primary-500/20 flex items-center justify-center text-primary-500 text-xs">
                      A
                    </div>
                    <div>
                      <p className="text-xs text-white">Arjun Kumar</p>
                      <p className="text-[10px] text-gray-500">4.9★ · Trips</p>
                    </div>
                  </div>

                  <span className="text-xs text-primary-500 bg-primary-500/10 px-2 py-1 rounded-full">
                    En Route
                  </span>
                </div>
              </motion.div>
              ...
              <div className="hidden lg:block">
                <div className="absolute -top-4 -left-6 glass-card px-3 py-2 rounded-lg">
                  4.9★ Rated
                </div>
                <div className="absolute top-1/2 -right-6 glass-card px-3 py-2 rounded-lg">
                  100% Insured
                </div>
