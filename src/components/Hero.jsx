  ...
  return (
    <section className="relative w-full max-w-full min-w-0 overflow-x-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden">
        ...
        {/* Glow orbs - constrained with max-w-full and overflow-hidden on parent */}
      ...
      {/* Main Container - Fixed: w-full max-w-7xl mx-auto, proper padding */}
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 flex flex-col lg:flex-row items-center gap-8 md:gap-12 lg:gap-16">
        ...
        <div className="flex-1 w-full min-w-0 text-center lg:text-left">
          ...
          {/* Heading - mobile: text-4xl, desktop: lg:text-6xl */}
          <motion.h1
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          {/* Main Card - constrained with overflow-hidden on parent */}
          <motion.div
            animate={{ y: [0, -10, 0] }}
            transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
          ...
          >
            {/* Image container - w-full max-w-full object-cover */}
            <div className="w-full h-40 sm:h-48 md:h-52 lg:h-64 rounded-xl sm:rounded-2xl overflow-hidden mb-4 border border-primary-500/10">
              <img
                src="/Hero.png"
                alt="Valet"
                className="w-full h-full object-cover"
